...
import topBarChart from "./topBarChart2.js";
import SelectorChart from "./SelectorChart.js";
import DataReader from "./DataReader.js";
    ...
    data_reader.promise.then(result => {
        barChart = new topBarChart(d3.select("svg.bars"),null, null, null, null, null, data_reader )
        selectorChart = new SelectorChart(d3.select("svg.bubbles"), data_reader)
    })
    
    

    let radar = new RadarChart(d3.select("svg.radar"), axes);
    ...
    function update_controls() {
        ...
        category1_control
            ...
            .on("input", () => {
                ...
                if (category1 == "All categories") category1 = null;
                category2 = null;
                category3 = null;
                update_selection();
    ...
    export default function send_selected(cat1, cat2, cat3, item_name, text){
        ...
        barChart =  new topBarChart(d3.select("svg.bars"), category1, category2, category3, country, selected_item_name, data_reader)
